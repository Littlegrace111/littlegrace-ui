...
import MonthPicker from "../../component/monthPicker/index2";
		...
		return (
			<div className="Page">
				...
				>
					...
					/>
					<PriceCount inCome={totalInCome} outCome={totalOutCome} />
				</div>
						...
						<Fragment>
							<div className="row text-center">
								<div className="col">
									<h5>这是收入</h5>
									<PieChart
										data={this.calculateItems(itemsWithCategory, "income")}
									/>
								</div>
								<div className="col">
									<h5>这是支出</h5>
									<PieChart
										data={this.calculateItems(itemsWithCategory, "outcome")}
									/>
								</div>
							</div>
						</Fragment>
					)}
					<CreateBtn onCreateItem={this.props.createItem} />
				</div>
				{/* <ScrollToTop /> */}
			</div>
		);
