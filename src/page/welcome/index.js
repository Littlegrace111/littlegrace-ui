...
import CatWithMouse from "../../component/hocDemo";
import CatWithMouse2 from "../../component/renderProps";
...
class WelcomePage extends Component {
	...
	render() {
		return (
			<Fragment>
				<Header />
				<CatWithMouse name="cat1" />
				<CatWithMouse2 name="cat2" />
				<BgImg>
					<div className="header-group">
						<h1>
							Pain is inevitable, <br /> Suffering is optional.
						</h1>
						<p>
							《菜根谭》里有句话：世利纷华，不近者为洁，近之而不染者，为尤洁。
						</p>
